...
export const CATEGORY_ICONS = [
    { name: 'Abasto',                   route: 'abasto',                    type: PLACES.TYPE.STORE ,       subCategory: PLACES.CATEGORY.FOOD},
    ...
    { name: 'Comercio de Vehículos',    route: 'comercio_de_vehiculos',     type: PLACES.TYPE.STORE ,       subCategory: PLACES.CATEGORY.FOOD},
    { name: 'Comida Rapida',            route: 'comida_rapida',             type: PLACES.TYPE.STORE ,       subCategory: PLACES.CATEGORY.FOOD},
    { name: 'Estacionamiento',          route: 'estacionamiento',           type: PLACES.TYPE.SERVICE ,     subCategory: PLACES.CATEGORY.SHOP},
    { name: 'Farmacia',                 route: 'farmacia',                  type: PLACES.TYPE.STORE ,       subCategory: PLACES.CATEGORY.SHOP},
    { name: 'Frutería',                 route: 'fruteria',                  type: PLACES.TYPE.STORE ,       subCategory: PLACES.CATEGORY.FOOD},
